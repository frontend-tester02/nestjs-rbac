...
exports.CreateInitialRbacSchema1763880000000 = void 0;
class CreateInitialRbacSchema1763880000000 {
    constructor() {
        this.name = 'CreateInitialRbacSchema1763880000000';
    }
    ...
    `);
        await queryRunner.query('CREATE UNIQUE INDEX "IDX_roles_name_unique" ON "roles" ("name")');
        await queryRunner.query('CREATE UNIQUE INDEX "IDX_permissions_name_unique" ON "permissions" ("name")');
        ...
        await queryRunner.query('CREATE INDEX "IDX_user_roles_assigned_by" ON "user_roles" ("assigned_by")');
...
exports.CreateInitialRbacSchema1763880000000 = CreateInitialRbacSchema1763880000000;
//# sourceMappingURL=1763880000000-CreateInitialRbacSchema.js.map